...
#      define ITKIOMeshBYU_EXPORT __attribute__((visibility("default")))
#    else
...
#    define ITKIOMeshBYU_HIDDEN __attribute__((visibility("hidden")))
#  endif
#endif

#ifndef ITKIOMESHBYU_DEPRECATED
#  define ITKIOMESHBYU_DEPRECATED __attribute__ ((__deprecated__))
#endif
