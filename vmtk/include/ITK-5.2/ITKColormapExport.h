...
#      define ITKColormap_EXPORT __attribute__((visibility("default")))
#    else
...
#    define ITKColormap_HIDDEN __attribute__((visibility("hidden")))
#  endif
#endif

#ifndef ITKCOLORMAP_DEPRECATED
#  define ITKCOLORMAP_DEPRECATED __attribute__ ((__deprecated__))
#endif
