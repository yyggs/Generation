...
#      define ITKRegionGrowing_EXPORT __attribute__((visibility("default")))
#    else
...
#    define ITKRegionGrowing_HIDDEN __attribute__((visibility("hidden")))
#  endif
#endif

#ifndef ITKREGIONGROWING_DEPRECATED
#  define ITKREGIONGROWING_DEPRECATED __attribute__ ((__deprecated__))
#endif
