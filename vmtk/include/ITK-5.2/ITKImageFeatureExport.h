...
#      define ITKImageFeature_EXPORT __attribute__((visibility("default")))
#    else
...
#    define ITKImageFeature_HIDDEN __attribute__((visibility("hidden")))
#  endif
#endif

#ifndef ITKIMAGEFEATURE_DEPRECATED
#  define ITKIMAGEFEATURE_DEPRECATED __attribute__ ((__deprecated__))
#endif
