...
#      define ITKDenoising_EXPORT __attribute__((visibility("default")))
#    else
...
#    define ITKDenoising_HIDDEN __attribute__((visibility("hidden")))
#  endif
#endif

#ifndef ITKDENOISING_DEPRECATED
#  define ITKDENOISING_DEPRECATED __attribute__ ((__deprecated__))
#endif
