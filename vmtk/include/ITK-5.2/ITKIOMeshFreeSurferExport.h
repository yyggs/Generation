...
#      define ITKIOMeshFreeSurfer_EXPORT __attribute__((visibility("default")))
#    else
...
#    define ITKIOMeshFreeSurfer_HIDDEN __attribute__((visibility("hidden")))
#  endif
#endif

#ifndef ITKIOMESHFREESURFER_DEPRECATED
#  define ITKIOMESHFREESURFER_DEPRECATED __attribute__ ((__deprecated__))
#endif
